...
const menuItems: MenuItem[] = [
  ...
  { id: 'raizes',   poetic: 'Raízes',    real: 'Comunicação',   path: '/comunicacao',   icon: RaizIcon },
  { id: 'caule',    poetic: 'Caule',     real: 'Configurações', path: '/configuracoes', icon: CauleConfigIcon },
];
