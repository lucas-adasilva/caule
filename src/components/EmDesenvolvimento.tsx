          ...
          <div className="bg-gray-800 rounded-3xl border border-gray-700 p-10 text-center relative overflow-hidden">
            ...
            <div className="absolute inset-0 opacity-5">
              <svg viewBox="0 0 200 200" className="w-full h-full">
                <path d="M100 20 Q60 60 100 100 Q140 140 100 180" stroke="#10b981" strokeWidth="2" fill="none"/>
                <path d="M100 40 Q70 70 100 100 Q130 130 100 160" stroke="#10b981" strokeWidth="1" fill="none"/>
              </svg>
            </div>

            <div className="relative">
              {/* Badge */}
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-600/20 rounded-full mb-6">
                <div className="w-2 h-2 bg-emerald-400 rounded-full animate-pulse" />
                <span className="text-emerald-400 text-sm font-medium">Em desenvolvimento</span>
              </div>
